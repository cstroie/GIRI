...
**`GHID.csv`** — 1418 rânduri (fără antet) × 13 coloane, UTF-8, cu diacritice românești
...
| # | Coloană | Descriere |
|---|---|---|
| 1 | `NR.CRT` | ID de rând, renumerotat **1..1421** (2026-07-10, după reviewul capitolului Coloană vertebrală); ulterior necontiguu (3 găuri: 1154, 1156, 1157, după comasarea „Nevralgie cervico-brahială"). **Doar identificator**, fără semnificație clinică. Între renumerotări poate deveni necontiguu (găuri după ștergeri; ID-uri noi la finalul secvenței); renumerotare doar la cerere explicită. |
...
## Structura pe capitole (1418 rânduri)
...
| 13 | Aparat locomotor | 1098–1171 (fără 1154–1157) | 70 |
